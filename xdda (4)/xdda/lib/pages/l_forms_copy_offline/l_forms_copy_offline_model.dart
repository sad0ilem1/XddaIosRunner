...
import '/index.dart';
import 'l_forms_copy_offline_widget.dart' show LFormsCopyOfflineWidget;
...
class LFormsCopyOfflineModel extends FlutterFlowModel<LFormsCopyOfflineWidget> {
  ...
  // Stores action output result for [Custom Action - checkConnection] action in LFormsCopyOffline widget.
  bool? net;
  InstantTimer? instantTimer;
  // Stores action output result for [Custom Action - checkConnection2] action in LFormsCopyOffline widget.
  bool? estaConectado;
