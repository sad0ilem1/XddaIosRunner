...
import 'l_forms_copy_offline_model.dart';
export 'l_forms_copy_offline_model.dart';

class LFormsCopyOfflineWidget extends StatefulWidget {
  const LFormsCopyOfflineWidget({super.key});

  static String routeName = 'LFormsCopyOffline';
  static String routePath = '/lFormsCopyOffline';

  @override
  State<LFormsCopyOfflineWidget> createState() =>
      _LFormsCopyOfflineWidgetState();
}

class _LFormsCopyOfflineWidgetState extends State<LFormsCopyOfflineWidget> {
  late LFormsCopyOfflineModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LFormsCopyOfflineModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      safeSetState(() {
        ...
        _model.txfLocalTextController?.clear();
      ...
      safeSetState(() {
        _model.isDataUploading_uploadData4 = false;
        _model.uploadedLocalFile_uploadData4 =
            FFUploadedFile(bytes: Uint8List.fromList([]));
      });

      safeSetState(() {
        _model.isDataUploading_uploadData5 = false;
        _model.uploadedLocalFile_uploadData5 =
            FFUploadedFile(bytes: Uint8List.fromList([]));
      });

      safeSetState(() {
        _model.isDataUploading_uploadData6 = false;
        _model.uploadedLocalFile_uploadData6 =
            FFUploadedFile(bytes: Uint8List.fromList([]));
      });

      safeSetState(() {
        _model.isDataUploading_uploadData7 = false;
        _model.uploadedLocalFile_uploadData7 =
            FFUploadedFile(bytes: Uint8List.fromList([]));
      });

      safeSetState(() {
        _model.isDataUploading_uploadData8 = false;
        _model.uploadedLocalFile_uploadData8 =
            FFUploadedFile(bytes: Uint8List.fromList([]));
      });

      safeSetState(() {
        _model.isDataUploading_uploadData9 = false;
                          ...
                          children: [
                            Align(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(MainmenuUserWidget.routeName);
                                },
                                child: Icon(
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            minLines: 1,
                            validator: _model.txfLocalTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                        ...
                        onPressed: () async {
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return AlertDialog(
                                title: Text('Conexão'),
                                content: Text(FFAppState().isOnline.toString()),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
                              ...
                              Align(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode: _model.descricaoFoto1FocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelStyle: FlutterFlowTheme.of(context)
                              ...
                              Align(
                                ...
                                child: Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    focusNode: _model.descricaoAcao1FocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelStyle: FlutterFlowTheme.of(context)
                                  ...
                                  onPressed: () async {
                                    if (FFAppState().isOnline != true) {
                                      ...
                                      await SQLiteManager.instance
                                        ...
                                        equipamento1: _model.equipamento1Value,
                                        txfResponsavel: _model
                                            .txfResponsavelTextController.text,
                                        txfData:
                                        ...
                                        descricaoFoto1: _model
                                            .descricaoFoto1TextController.text,
                                        descricaoAcao1: _model
                                            .descricaoAcao1TextController.text,
                                        prazo1:
                                        ...
                                        ncampos: FFAppState().numCamposVisiveis,
                                        ...
                                        impeditivo10: FFAppState().impedido10,
                                        txfCliente: _model
                                      ...
                                      safeSetState(() {
                                        ...
                                        _model.dpdEquipamento9ValueController
                                            ?.reset();
                                        _model.dpdEquipamento10xValueController
                                            ?.reset();
                                        _model.status1ValueController?.reset();
                                        _model.dpdStatus2ValueController
                                            ?.reset();
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    await actions.gerarPDF2Copy(
                                      _model.txfResponsavelTextController.text,
                                      ...
                                      _model.tipoInspecao1TextController.text,
                                      _model.equipamento1Value,
                                      _model.impeditivo1Value,
                                      _model.motivo1TextController.text,
                                      '',
                                      _model.descricaoFoto1TextController.text,
                                      _model.descricaoAcao1TextController.text,
                                      _model.prazo1TextController.text,
                                      _model.status1Value,
                                      _model.txfOutraInsp2TextController.text,
                                      _model.dpdEquipamento2Value,
                                      _model.impedimento2Value,
