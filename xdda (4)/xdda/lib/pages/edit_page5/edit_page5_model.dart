...
import '/index.dart';
import 'dart:async';
import 'edit_page5_widget.dart' show EditPage5Widget;
...
class EditPage5Model extends FlutterFlowModel<EditPage5Widget> {
  ...
  bool isDataUploading_uploadData1bz = false;
  FFUploadedFile uploadedLocalFile_uploadData1bz =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData1bz = '';
  ...
  bool isDataUploading_uploadData2bzaa = false;
  FFUploadedFile uploadedLocalFile_uploadData2bzaa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData2bzaa = '';
  ...
  bool isDataUploading_uploadDataM3bcxaa = false;
  FFUploadedFile uploadedLocalFile_uploadDataM3bcxaa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataM3bcxaa = '';
  ...
  bool isDataUploading_uploadDataM3bcxa = false;
  FFUploadedFile uploadedLocalFile_uploadDataM3bcxa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataM3bcxa = '';
  ...
  bool isDataUploading_uploadDataM5bcxa = false;
  FFUploadedFile uploadedLocalFile_uploadDataM5bcxa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataM5bcxa = '';
  ...
  bool isDataUploading_uploadDataM6bcxa = false;
  FFUploadedFile uploadedLocalFile_uploadDataM6bcxa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataM6bcxa = '';
  ...
  bool isDataUploading_uploadDataM7bcxa = false;
  FFUploadedFile uploadedLocalFile_uploadDataM7bcxa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataM7bcxa = '';
  ...
  bool isDataUploading_uploadDataM8bcxa = false;
  FFUploadedFile uploadedLocalFile_uploadDataM8bcxa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataM8bcxa = '';
  ...
  bool isDataUploading_uploadDataM9bcxa = false;
  FFUploadedFile uploadedLocalFile_uploadDataM9bcxa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataM9bcxa = '';
  ...
  bool isDataUploading_uploadDataM10bcxa = false;
  FFUploadedFile uploadedLocalFile_uploadDataM10bcxa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataM10bcxa = '';
