...
import '/index.dart';
import 'dart:async';
import 'l_forms_copy_widget.dart' show LFormsCopyWidget;
...
class LFormsCopyModel extends FlutterFlowModel<LFormsCopyWidget> {
  ...
  // Stores action output result for [Custom Action - checkConnection] action in LFormsCopy widget.
  bool? net;
  Completer<List<FormsRow>>? requestCompleter;
  InstantTimer? instantTimer;
  // Stores action output result for [Custom Action - checkConnection2] action in LFormsCopy widget.
  bool? estaConectado;
  // Stores action output result for [Custom Action - converterCoordenadasEmEndereco] action in LFormsCopy widget.
  String? enderecoConvertido;
  // State field(s) for txfResponsavel widget.
  FocusNode? txfResponsavelFocusNode;
  TextEditingController? txfResponsavelTextController;
  String? Function(BuildContext, String?)?
      txfResponsavelTextControllerValidator;
  // State field(s) for idcamp widget.
  FocusNode? idcampFocusNode;
  TextEditingController? idcampTextController;
  String? Function(BuildContext, String?)? idcampTextControllerValidator;
  ...
  // State field(s) for txfLocal widget.
  FocusNode? txfLocalFocusNode;
  TextEditingController? txfLocalTextController;
  String? Function(BuildContext, String?)? txfLocalTextControllerValidator;
  // Stores action output result for [Custom Action - converterCoordenadasEmEndereco] action in Button widget.
  String? enderecoConvertido1;
  // Stores action output result for [Custom Action - checkConnection2] action in Button widget.
  bool? estaConectadox;
  // State field(s) for dpdInspecao1 widget.
  String? dpdInspecao1Value;
  FormFieldController<String>? dpdInspecao1ValueController;
  // State field(s) for tipoInspecao1 widget.
  final tipoInspecao1Key = GlobalKey();
  FocusNode? tipoInspecao1FocusNode;
  TextEditingController? tipoInspecao1TextController;
  String? tipoInspecao1SelectedOption;
  String? Function(BuildContext, String?)? tipoInspecao1TextControllerValidator;
  // State field(s) for equipamento1 widget.
  String? equipamento1Value;
  FormFieldController<String>? equipamento1ValueController;
  // State field(s) for impeditivo1 widget.
  bool? impeditivo1Value;
  // State field(s) for motivo1 widget.
  FocusNode? motivo1FocusNode;
  TextEditingController? motivo1TextController;
  String? Function(BuildContext, String?)? motivo1TextControllerValidator;
  bool isDataUploading_uploadDataHh1x = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh1x =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataHh1x = '';

  // Stores action output result for [Backend Call - Update Row(s)] action in image1 widget.
  List<FormsRow>? foto1t;
  bool isDataUploading_uploadData1xa = false;
  FFUploadedFile uploadedLocalFile_uploadData1xa =
      FFUploadedFile(bytes: Uint8List.fromList([]));

  // State field(s) for descricaoFoto1 widget.
  FocusNode? descricaoFoto1FocusNode;
  TextEditingController? descricaoFoto1TextController;
  String? Function(BuildContext, String?)?
      descricaoFoto1TextControllerValidator;
  // State field(s) for descricaoAcao1 widget.
  FocusNode? descricaoAcao1FocusNode;
  TextEditingController? descricaoAcao1TextController;
  String? Function(BuildContext, String?)?
      descricaoAcao1TextControllerValidator;
  // State field(s) for prazo1 widget.
  FocusNode? prazo1FocusNode;
  TextEditingController? prazo1TextController;
  final prazo1Mask = MaskTextInputFormatter(mask: '##/##/####');
  String? Function(BuildContext, String?)? prazo1TextControllerValidator;
  ...
  // State field(s) for txfOutraInsp2 widget.
  final txfOutraInsp2Key = GlobalKey();
  FocusNode? txfOutraInsp2FocusNode;
  TextEditingController? txfOutraInsp2TextController;
  String? txfOutraInsp2SelectedOption;
  String? Function(BuildContext, String?)? txfOutraInsp2TextControllerValidator;
  ...
  bool isDataUploading_uploadData2bx = false;
  FFUploadedFile uploadedLocalFile_uploadData2bx =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData2bx = '';

  bool isDataUploading_uploadData2xza = false;
  FFUploadedFile uploadedLocalFile_uploadData2xza =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  ...
  bool isDataUploading_uploadDataM3bcxat = false;
  FFUploadedFile uploadedLocalFile_uploadDataM3bcxat =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataM3bcxat = '';

  bool isDataUploading_uploadDataM3bcxaagth = false;
  FFUploadedFile uploadedLocalFile_uploadDataM3bcxaagth =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  ...
  bool isDataUploading_uploadDataHh4x = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh4x =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataHh4x = '';

  bool isDataUploading_uploadDataHh4xa = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh4xa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  ...
  bool isDataUploading_uploadDataHh5x = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh5x =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataHh5x = '';

  bool isDataUploading_uploadDataHh5xa = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh5xa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  ...
  bool isDataUploading_uploadDataHh6x = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh6x =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataHh6x = '';

  // Stores action output result for [Backend Call - Update Row(s)] action in image6 widget.
  List<FormsRow>? foto6;
  bool isDataUploading_uploadDataHh6xa = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh6xa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  ...
  bool isDataUploading_uploadDataHh7x = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh7x =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataHh7x = '';

  bool isDataUploading_uploadDataHh7xa = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh7xa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  ...
  bool isDataUploading_uploadDataHh8x = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh8x =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataHh8x = '';

  bool isDataUploading_uploadDataHh8xa = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh8xa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  ...
  bool isDataUploading_uploadDataHh9x = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh9x =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataHh9x = '';

  bool isDataUploading_uploadDataHh9xa = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh9xa =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  ...
  // State field(s) for dpdEquipamento10x widget.
  String? dpdEquipamento10xValue;
  FormFieldController<String>? dpdEquipamento10xValueController;
  ...
  bool isDataUploading_uploadDataHh10z = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh10z =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadDataHh10z = '';

  bool isDataUploading_uploadDataHh10za = false;
  FFUploadedFile uploadedLocalFile_uploadDataHh10za =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  ...
  List<FormsRow>? foto1taaaaa;
  // Stores action output result for [Backend Call - Update Row(s)] action in Button widget.
  List<FormsRow>? foto1taaaaatt;
  // Stores action output result for [Backend Call - Update Row(s)] action in Button widget.
  List<FormsRow>? foto1taaaaata;
  // Stores action output result for [Backend Call - SQLite (getInspecaoLocal)] action in btnSincronizar widget.
  List<GetInspecaoLocalRow>? dadosSincronizados;
  ...
  void dispose() {
    instantTimer?.cancel();
    txfResponsavelFocusNode?.dispose();
    txfResponsavelTextController?.dispose();

    idcampFocusNode?.dispose();
    idcampTextController?.dispose();
    ...
    txfLocalFocusNode?.dispose();
    txfLocalTextController?.dispose();

    tipoInspecao1FocusNode?.dispose();

    motivo1FocusNode?.dispose();
    motivo1TextController?.dispose();

    descricaoFoto1FocusNode?.dispose();
    descricaoFoto1TextController?.dispose();

    descricaoAcao1FocusNode?.dispose();
    descricaoAcao1TextController?.dispose();

    prazo1FocusNode?.dispose();
    prazo1TextController?.dispose();

    txfOutraInsp2FocusNode?.dispose();
